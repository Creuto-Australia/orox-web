  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div
            className="group flex items-center space-x-2 text-[#2F5DFD] mt-[24px] hover:text-[#21275B] hover:bg-[#21275B]/10 p-[8px] transition-all duration-300 w-fit"
            style={{
              transitionProperty:
                  "color, background-color, border-radius, padding, transform",
            }}
        >
